        ...
        <div class="panel-body">
            <form method="post" id="editForm" action="admin_product_update">
                <table class="editTable">
                    ...
                    <tr>
                        <td>产品小标题</td>
                        <td><input  id="sub_title" name="sub_title" value="${p.sub_title}" type="text" class="form-control"></td>
                    </tr>
                    <tr>
                        <td>原价格</td>
                        <td><input  id="original_price" name="original_price" value="${p.original_price}" type="text" class="form-control"></td>
                    </tr>
                    <tr>
                        <td>优惠价格</td>
                        <td><input  id="promote_price" name="promote_price" value="${p.promote_price}" type="text" class="form-control"></td>
                    </tr>
                    <tr>
                        <td>库存</td>
